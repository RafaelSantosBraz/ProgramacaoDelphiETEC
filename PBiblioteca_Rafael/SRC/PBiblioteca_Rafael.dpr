...
uses
  ...
  Unit_Cadastro_Funcionario in 'Unit_Cadastro_Funcionario.pas' {Frm_Cadastro_Funcionario};
...
begin
  ...
  Application.CreateForm(TFrm_Cadastro_Funcionario, Frm_Cadastro_Funcionario);
  Application.Run;
end.
