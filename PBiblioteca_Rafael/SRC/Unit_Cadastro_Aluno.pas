...
procedure TFrm_Cadastro_Aluno.DBEdit1Enter(Sender: TObject);
begin
DBEdit1.Color := $009E8D30;
DBEdit1.Font.Color := clWindow;
end;

procedure TFrm_Cadastro_Aluno.DBEdit1Exit(Sender: TObject);
begin
DBEdit1.Color := $002D7EEE;
DBEdit1.Font.Color := clBlack;
end;

procedure TFrm_Cadastro_Aluno.DBEdit6Enter(Sender: TObject);
begin
DBEdit6.Color := $009E8D30;
DBEdit6.Font.Color := clWindow;
end;

procedure TFrm_Cadastro_Aluno.DBEdit6Exit(Sender: TObject);
begin
DBEdit6.Color := $002D7EEE;
DBEdit6.Font.Color := clBlack;
end;

procedure TFrm_Cadastro_Aluno.DBEdit7Exit(Sender: TObject);
begin
DBEdit7.Color := $002D7EEE;
DBEdit7.Font.Color := clBlack;
end;

procedure TFrm_Cadastro_Aluno.DBEdit7Enter(Sender: TObject);
begin
DBEdit7.Color := $009E8D30;
DBEdit7.Font.Color := clWindow;
end;

procedure TFrm_Cadastro_Aluno.DBEdit8Enter(Sender: TObject);
begin
DBEdit8.Color := $009E8D30;
DBEdit8.Font.Color := clWindow;
end;

procedure TFrm_Cadastro_Aluno.DBEdit8Exit(Sender: TObject);
begin
DBEdit8.Color := $002D7EEE;
DBEdit8.Font.Color := clBlack;
end;

procedure TFrm_Cadastro_Aluno.DBEdit2Exit(Sender: TObject);
begin
DBEdit2.Color := $002D7EEE;
DBEdit2.Font.Color := clBlack;
end;

procedure TFrm_Cadastro_Aluno.DBEdit2Enter(Sender: TObject);
begin
DBEdit2.Color := $009E8D30;
DBEdit2.Font.Color := clWindow;
end;

procedure TFrm_Cadastro_Aluno.DBEdit3Enter(Sender: TObject);
begin
DBEdit3.Color := $009E8D30;
DBEdit3.Font.Color := clWindow;
end;

procedure TFrm_Cadastro_Aluno.DBEdit3Exit(Sender: TObject);
begin
DBEdit3.Color := $002D7EEE;
DBEdit3.Font.Color := clBlack;
end;

procedure TFrm_Cadastro_Aluno.DBEdit4Exit(Sender: TObject);
begin
DBEdit4.Color := $002D7EEE;
DBEdit4.Font.Color := clBlack;
end;

procedure TFrm_Cadastro_Aluno.DBEdit4Enter(Sender: TObject);
begin
DBEdit4.Color := $009E8D30;
DBEdit4.Font.Color := clWindow;
end;

procedure TFrm_Cadastro_Aluno.DBEdit5Enter(Sender: TObject);
begin
DBEdit5.Color := $009E8D30;
DBEdit5.Font.Color := clWindow;
end;

procedure TFrm_Cadastro_Aluno.DBEdit5Exit(Sender: TObject);
begin
DBEdit5.Color := $002D7EEE;
DBEdit5.Font.Color := clBlack;
end;

procedure TFrm_Cadastro_Aluno.DBMemo2Exit(Sender: TObject);
begin
DBMemo2.Color := $002D7EEE;
DBMemo2.Font.Color := clBlack;
end;

procedure TFrm_Cadastro_Aluno.DBMemo2Enter(Sender: TObject);
begin
DBMemo2.Color := $009E8D30;
DBMemo2.Font.Color := clWindow;
end;

procedure TFrm_Cadastro_Aluno.DBMemo1Enter(Sender: TObject);
begin
DBMemo1.Color := $009E8D30;
DBMemo1.Font.Color := clWindow;
end;

procedure TFrm_Cadastro_Aluno.DBMemo1Exit(Sender: TObject);
begin
DBMemo1.Color := $002D7EEE;
DBMemo1.Font.Color := clBlack;
end;

procedure TFrm_Cadastro_Aluno.DBComboBox1Exit(Sender: TObject);
begin
DBComboBox1.Color := $002D7EEE;
DBComboBox1.Font.Color := clBlack;
end;

procedure TFrm_Cadastro_Aluno.DBComboBox1Enter(Sender: TObject);
begin
DBComboBox1.Color := $009E8D30;
DBComboBox1.Font.Color := clWindow;
end;

procedure TFrm_Cadastro_Aluno.DBComboBox2Enter(Sender: TObject);
begin
DBComboBox2.Color := $009E8D30;
DBComboBox2.Font.Color := clWindow;
end;

procedure TFrm_Cadastro_Aluno.DBComboBox2Exit(Sender: TObject);
begin
DBComboBox2.Color := $002D7EEE;
DBComboBox2.Font.Color := clBlack;
end;

procedure TFrm_Cadastro_Aluno.DBEdit9Exit(Sender: TObject);
begin
DBEdit9.Color := $002D7EEE;
DBEdit9.Font.Color := clBlack;
end;

procedure TFrm_Cadastro_Aluno.DBEdit9Enter(Sender: TObject);
begin
DBEdit9.Color := $009E8D30;
DBEdit9.Font.Color := clWindow;
end;

procedure TFrm_Cadastro_Aluno.DBMemo3Enter(Sender: TObject);
begin
DBMemo3.Color := $009E8D30;
DBMemo3.Font.Color := clWindow;
end;

procedure TFrm_Cadastro_Aluno.DBMemo3Exit(Sender: TObject);
begin
DBMemo3.Color := $002D7EEE;
DBMemo3.Font.Color := clBlack;
end;

procedure TFrm_Cadastro_Aluno.DBEdit10Exit(Sender: TObject);
begin
DBEdit10.Color := $002D7EEE;
DBEdit10.Font.Color := clBlack;
end;

procedure TFrm_Cadastro_Aluno.DBEdit10Enter(Sender: TObject);
begin
DBEdit10.Color := $009E8D30;
DBEdit10.Font.Color := clWindow;
end;

procedure TFrm_Cadastro_Aluno.DBEdit12Enter(Sender: TObject);
begin
DBEdit12.Color := $009E8D30;
DBEdit12.Font.Color := clWindow;
end;

procedure TFrm_Cadastro_Aluno.DBEdit12Exit(Sender: TObject);
begin
DBEdit12.Color := $002D7EEE;
DBEdit12.Font.Color := clBlack;
end;

procedure TFrm_Cadastro_Aluno.DBEdit11Exit(Sender: TObject);
begin
DBEdit11.Color := $002D7EEE;
DBEdit11.Font.Color := clBlack;
end;

procedure TFrm_Cadastro_Aluno.DBEdit11Enter(Sender: TObject);
begin
...
procedure TFrm_Cadastro_Aluno.DBEdit1KeyPress(Sender: TObject;
  var Key: Char);
begin
If Key = #13 Then
  Begin
...
procedure TFrm_Cadastro_Aluno.DBEdit6KeyPress(Sender: TObject;
  var Key: Char);
begin
If Key = #13 Then
  Begin
...
procedure TFrm_Cadastro_Aluno.DBEdit7KeyPress(Sender: TObject;
  var Key: Char);
begin
If Key = #13 Then
  Begin
...
procedure TFrm_Cadastro_Aluno.DBEdit8KeyPress(Sender: TObject;
  var Key: Char);
begin
If Key = #13 Then
  Begin
...
procedure TFrm_Cadastro_Aluno.DBEdit2KeyPress(Sender: TObject;
  var Key: Char);
begin
If Key = #13 Then
  Begin
...
procedure TFrm_Cadastro_Aluno.DBEdit3KeyPress(Sender: TObject;
  var Key: Char);
begin
If Key = #13 Then
  Begin
...
procedure TFrm_Cadastro_Aluno.DBEdit4KeyPress(Sender: TObject;
  var Key: Char);
begin
If Key = #13 Then
  Begin
...
procedure TFrm_Cadastro_Aluno.DBEdit5KeyPress(Sender: TObject;
  var Key: Char);
begin
If Key = #13 Then
  Begin
...
procedure TFrm_Cadastro_Aluno.DBComboBox1KeyPress(Sender: TObject;
  var Key: Char);
begin
If Key = #13 Then
  Begin
...
procedure TFrm_Cadastro_Aluno.DBComboBox2KeyPress(Sender: TObject;
  var Key: Char);
begin
If Key = #13 Then
  Begin
...
procedure TFrm_Cadastro_Aluno.DBEdit9KeyPress(Sender: TObject;
  var Key: Char);
begin
If Key = #13 Then
  Begin
...
procedure TFrm_Cadastro_Aluno.DBMemo3KeyPress(Sender: TObject;
  var Key: Char);
begin
If Key = #13 Then
  Begin
...
procedure TFrm_Cadastro_Aluno.DBEdit10KeyPress(Sender: TObject;
  var Key: Char);
begin
If Key = #13 Then
  Begin
...
procedure TFrm_Cadastro_Aluno.DBEdit12KeyPress(Sender: TObject;
  var Key: Char);
begin
If Key = #13 Then
  Begin
...
procedure TFrm_Cadastro_Aluno.DBEdit11KeyPress(Sender: TObject;
  var Key: Char);
begin
If Key = #13 Then
  Begin
...
procedure TFrm_Cadastro_Aluno.DBEdit13KeyPress(Sender: TObject;
  var Key: Char);
begin
If Key = #13 Then
  Begin
...
procedure TFrm_Cadastro_Aluno.Pesquisar1Click(Sender: TObject);
begin
Limpar_Campos;
Origem := Frm_Cadastro_Aluno;
Destino := Frm_Selecao;
