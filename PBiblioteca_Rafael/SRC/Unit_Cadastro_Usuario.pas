...
uses
  ...
  Buttons, FileCtrl, jpeg, DBCtrls, Mask, StrUtils;
...
uses Unit_Pesquisa, Unit_Principal, Unit_Login, Unit_Cadastro_Livro,
  Unit_Cadastro_DVD, Unit_Cadastro_Periodico, Unit_Cadastro_TCC,
  Unit_Cadastro_Aluno, Unit_Cadastro_Professor;

{$R *.dfm}

procedure TFrm_Cadastro_Usuario.SairdoSistema1Click(Sender: TObject);
begin
Frm_Cadastro_Usuario.Close;
end;

procedure TFrm_Cadastro_Usuario.SairdoSistema2Click(Sender: TObject);
begin
If messagedlg('Deseja sair do Sistema?',mtconfirmation,[mbno, mbyes],0)= mryes Then
  Begin
    Origem := Frm_Cadastro_Usuario;
    Transicao := 'Fim';
    Frm_Principal.Timer2.Enabled := True;
End;
end;

procedure TFrm_Cadastro_Usuario.FazerLogof1Click(Sender: TObject);
begin
...
procedure TFrm_Cadastro_Usuario.InserirImagem1Click(Sender: TObject);
begin
BitBtn3.Click;
end;

procedure TFrm_Cadastro_Usuario.Salvar1Click(Sender: TObject);
begin
BitBtn5.Click;
end;

procedure TFrm_Cadastro_Usuario.Cancelar1Click(Sender: TObject);
begin
BitBtn6.Click;
end;

procedure TFrm_Cadastro_Usuario.CadastrarLivros1Click(Sender: TObject);
begin
Limpar_Campos;
Origem := Frm_Cadastro_Usuario;
...
procedure TFrm_Cadastro_Usuario.Limpar_Campos;
begin
DBEdit1.Clear;
DBEdit2.Clear;
DBEdit3.Clear;
...
procedure TFrm_Cadastro_Usuario.CadastrarDVDs1Click(Sender: TObject);
begin
Limpar_Campos;
Origem := Frm_Cadastro_Usuario;
...
procedure TFrm_Cadastro_Usuario.CadastrarPeridicos1Click(Sender: TObject);
begin
Limpar_Campos;
Origem := Frm_Cadastro_Usuario;
...
procedure TFrm_Cadastro_Usuario.CadastrarTCCs1Click(Sender: TObject);
begin
Limpar_Campos;
Origem := Frm_Cadastro_Usuario;
...
procedure TFrm_Cadastro_Usuario.CadastrarAlunis1Click(Sender: TObject);
begin
Limpar_Campos;
Origem := Frm_Cadastro_Usuario;
...
procedure TFrm_Cadastro_Usuario.CadastrarProfessores1Click(
  Sender: TObject);
begin
Limpar_Campos;
Origem := Frm_Cadastro_Usuario;
...
procedure TFrm_Cadastro_Usuario.Timer1Timer(Sender: TObject);
begin
If Estado = True Then
  Begin
    DirectoryListBox1.Visible := True;
    FileListBox1.Visible := True;
    If Frm_Cadastro_Usuario.Height <> 816 Then
      Begin
        Frm_Cadastro_Usuario.Height := Frm_Cadastro_Usuario.Height + 6;
    End;
    If Frm_Cadastro_Usuario.Height = 816 Then
      Begin
...
Else
  Begin
    If Frm_Cadastro_Usuario.Height <> 456 Then
      Begin
        Frm_Cadastro_Usuario.Height := Frm_Cadastro_Usuario.Height - 6;
    End;
    If Frm_Cadastro_Usuario.Height = 456 Then
...
procedure TFrm_Cadastro_Usuario.DBEdit1Enter(Sender: TObject);
begin
DBEdit1.Color := $009E8D30;
DBEdit1.Font.Color := clWindow;
end;

procedure TFrm_Cadastro_Usuario.DBEdit2Enter(Sender: TObject);
begin
DBEdit2.Color := $009E8D30;
DBEdit2.Font.Color := clWindow;
end;

procedure TFrm_Cadastro_Usuario.DBEdit3Enter(Sender: TObject);
begin
DBEdit3.Color := $009E8D30;
DBEdit3.Font.Color := clWindow;
end;

procedure TFrm_Cadastro_Usuario.DBEdit4Enter(Sender: TObject);
begin
DBEdit4.Color := $009E8D30;
DBEdit4.Font.Color := clWindow;
end;

procedure TFrm_Cadastro_Usuario.DBEdit5Enter(Sender: TObject);
begin
DBEdit5.Color := $009E8D30;
DBEdit5.Font.Color := clWindow;
end;

procedure TFrm_Cadastro_Usuario.DBEdit6Enter(Sender: TObject);
begin
DBEdit6.Color := $009E8D30;
DBEdit6.Font.Color := clWindow;
end;

procedure TFrm_Cadastro_Usuario.DBComboBox1Enter(Sender: TObject);
begin
DBComboBox1.Color := $009E8D30;
DBComboBox1.Font.Color := clWindow;
end;

procedure TFrm_Cadastro_Usuario.DBEdit7Enter(Sender: TObject);
begin
DBEdit7.Color := $009E8D30;
DBEdit7.Font.Color := clWindow;
end;

procedure TFrm_Cadastro_Usuario.DBEdit8Enter(Sender: TObject);
begin
DBEdit8.Color := $009E8D30;
DBEdit8.Font.Color := clWindow;
end;

procedure TFrm_Cadastro_Usuario.DBEdit12Enter(Sender: TObject);
begin
DBEdit12.Color := $009E8D30;
DBEdit12.Font.Color := clWindow;
end;

procedure TFrm_Cadastro_Usuario.DBEdit13Enter(Sender: TObject);
begin
DBEdit13.Color := $009E8D30;
DBEdit13.Font.Color := clWindow;
end;

procedure TFrm_Cadastro_Usuario.DBMemo2Enter(Sender: TObject);
begin
DBMemo2.Color := $009E8D30;
DBMemo2.Font.Color := clWindow;
end;

procedure TFrm_Cadastro_Usuario.DBEdit14Enter(Sender: TObject);
begin
DBEdit14.Color := $009E8D30;
DBEdit14.Font.Color := clWindow;
end;

procedure TFrm_Cadastro_Usuario.DBEdit9Enter(Sender: TObject);
begin
DBEdit9.Color := $009E8D30;
DBEdit9.Font.Color := clWindow;
end;

procedure TFrm_Cadastro_Usuario.DBEdit10Enter(Sender: TObject);
begin
DBEdit10.Color := $009E8D30;
DBEdit10.Font.Color := clWindow;
end;

procedure TFrm_Cadastro_Usuario.DBMemo3Enter(Sender: TObject);
begin
DBMemo3.Color := $009E8D30;
DBMemo3.Font.Color := clWindow;
end;

procedure TFrm_Cadastro_Usuario.DBEdit11Enter(Sender: TObject);
begin
DBEdit11.Color := $009E8D30;
DBEdit11.Font.Color := clWindow;
end;

procedure TFrm_Cadastro_Usuario.DBEdit1Exit(Sender: TObject);
begin
DBEdit1.Color := $002D7EEE;
DBEdit1.Font.Color := clBlack;
end;

procedure TFrm_Cadastro_Usuario.DBEdit2Exit(Sender: TObject);
begin
DBEdit2.Color := $002D7EEE;
DBEdit2.Font.Color := clBlack;
end;

procedure TFrm_Cadastro_Usuario.DBEdit3Exit(Sender: TObject);
begin
DBEdit3.Color := $002D7EEE;
DBEdit3.Font.Color := clBlack;
end;

procedure TFrm_Cadastro_Usuario.DBEdit4Exit(Sender: TObject);
begin
DBEdit4.Color := $002D7EEE;
DBEdit4.Font.Color := clBlack;
end;

procedure TFrm_Cadastro_Usuario.DBEdit5Exit(Sender: TObject);
begin
DBEdit5.Color := $002D7EEE;
DBEdit5.Font.Color := clBlack;
end;

procedure TFrm_Cadastro_Usuario.DBEdit6Exit(Sender: TObject);
begin
DBEdit6.Color := $002D7EEE;
DBEdit6.Font.Color := clBlack;
end;

procedure TFrm_Cadastro_Usuario.DBComboBox1Exit(Sender: TObject);
begin
DBComboBox1.Color := $002D7EEE;
DBComboBox1.Font.Color := clBlack;
end;

procedure TFrm_Cadastro_Usuario.DBEdit7Exit(Sender: TObject);
begin
DBEdit7.Color := $002D7EEE;
DBEdit7.Font.Color := clBlack;
end;

procedure TFrm_Cadastro_Usuario.DBEdit8Exit(Sender: TObject);
begin
DBEdit8.Color := $002D7EEE;
DBEdit8.Font.Color := clBlack;
end;

procedure TFrm_Cadastro_Usuario.DBEdit12Exit(Sender: TObject);
begin
DBEdit12.Color := $002D7EEE;
DBEdit12.Font.Color := clBlack;
end;

procedure TFrm_Cadastro_Usuario.DBEdit13Exit(Sender: TObject);
begin
DBEdit13.Color := $002D7EEE;
DBEdit13.Font.Color := clBlack;
end;

procedure TFrm_Cadastro_Usuario.DBMemo2Exit(Sender: TObject);
begin
DBMemo2.Color := $002D7EEE;
DBMemo2.Font.Color := clBlack;
end;

procedure TFrm_Cadastro_Usuario.DBEdit14Exit(Sender: TObject);
begin
DBEdit14.Color := $002D7EEE;
DBEdit14.Font.Color := clBlack;
end;

procedure TFrm_Cadastro_Usuario.DBEdit9Exit(Sender: TObject);
begin
DBEdit9.Color := $002D7EEE;
DBEdit9.Font.Color := clBlack;
end;

procedure TFrm_Cadastro_Usuario.DBEdit10Exit(Sender: TObject);
begin
DBEdit10.Color := $002D7EEE;
DBEdit10.Font.Color := clBlack;
end;

procedure TFrm_Cadastro_Usuario.DBMemo3Exit(Sender: TObject);
begin
DBMemo3.Color := $002D7EEE;
DBMemo3.Font.Color := clBlack;
end;

procedure TFrm_Cadastro_Usuario.DBEdit11Exit(Sender: TObject);
begin
    ...
    Else
      Begin
        If DBEdit11.Text <> '' Then
          Begin
            ADOTable1.FieldValues['Foto_Usuario'] := 'C:\PBiblioteca_Rafael\Fotos\' + FileListBox1.Items[FileListBox1.ItemIndex];
        End;
        ADOTable1.Post;
...
function TFrm_Cadastro_Usuario.Verificar_Campos(): Boolean;
var
Resultado: Boolean;
begin
Resultado := False;
...
If DBEdit13.Text = '' Then
  Begin
    DBEdit13.Color := $000000E3;
    Resultado := True;
End;
If DBEdit14.Text = '' Then
  Begin
    DBEdit14.Color := $000000E3;
    Resultado := True;
End;
...
procedure TFrm_Cadastro_Usuario.Pesquisar1Click(Sender: TObject);
begin
Limpar_Campos;
Origem := Frm_Cadastro_Usuario;
Destino := Frm_Selecao;
