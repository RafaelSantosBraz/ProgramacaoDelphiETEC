...
type
  TFrm_Principal = class(TForm)
    ...
    procedure Retirar_Filtro;
    procedure Pesquisar1Click(Sender: TObject);
    procedure Image9Click(Sender: TObject);
    procedure CadastrarFuncionrios1Click(Sender: TObject);
  private
...
uses Unit_Cadastro_Livro, Unit_Login, ConvUtils, Unit_Splash,
  ...
  Unit_Pesquisa, Unit_Cadastro_Funcionario;

{$R *.dfm}

procedure TFrm_Principal.Retirar_Filtro;
begin
Frm_Cadastro_Usuario.DataSource1.DataSet.Filtered := False;
Frm_Cadastro_Professor.DataSource1.DataSet.Filtered := False;
Frm_Cadastro_Aluno.DataSource1.DataSet.Filtered := False;
Frm_Cadastro_TCC.DataSource1.DataSet.Filtered := False;
Frm_Cadastro_Periodico.DataSource1.DataSet.Filtered := False;
Frm_Cadastro_DVD.DataSource1.DataSet.Filtered := False;
Frm_Cadastro_Livro.DataSource1.DataSet.Filtered := False;
end;
...
Frm_Cadastro_Usuario.StatusBar1.Panels[3].Text := DateToStr(Date) + '  ' +  TimeToStr(Time);
Frm_Cadastro_Usuario.StatusBar1.Panels[0].Text := 'Biblioteca';
Frm_Cadastro_Usuario.StatusBar1.Panels[1].Text := Usuario;
//Frm_Selecao
Frm_Selecao.StatusBar1.Panels[3].Text := DateToStr(Date) + '  ' +  TimeToStr(Time);
Frm_Selecao.StatusBar1.Panels[0].Text := 'Biblioteca';
Frm_Selecao.StatusBar1.Panels[1].Text := Usuario;
//Frm_Cadastro_Aluno
Frm_Cadastro_Aluno.StatusBar1.Panels[3].Text := DateToStr(Date) + '  ' +  TimeToStr(Time);
Frm_Cadastro_Aluno.StatusBar1.Panels[0].Text := 'Biblioteca';
Frm_Cadastro_Aluno.StatusBar1.Panels[1].Text := Usuario;
//Frm_Cadastro_Professor
Frm_Cadastro_Professor.StatusBar1.Panels[3].Text := DateToStr(Date) + '  ' +  TimeToStr(Time);
Frm_Cadastro_Professor.StatusBar1.Panels[0].Text := 'Biblioteca';
Frm_Cadastro_Professor.StatusBar1.Panels[1].Text := Usuario;
end;
...
procedure TFrm_Principal.Pesquisar1Click(Sender: TObject);
begin
...
begin
Origem := Frm_Principal;
Destino := Frm_Cadastro_Funcionario;
Transicao := 'Comum';
Frm_Cadastro_Funcionario.show;
Timer2.Enabled := True;
end;

procedure TFrm_Principal.CadastrarFuncionrios1Click(Sender: TObject);
begin
Image9Click(Image9);
end;
