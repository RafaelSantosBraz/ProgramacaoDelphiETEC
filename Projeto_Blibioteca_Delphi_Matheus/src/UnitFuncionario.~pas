...
uses
  ...
  Dialogs, Mask, DBCtrls, StdCtrls, TFlatGroupBoxUnit, TFlatButtonUnit,
  ComCtrls, TFlatGaugeUnit, jpeg, ExtCtrls, TFlatPanelUnit, DB, ADODB, XPMan;
...
uses UnitAluno, UnitTCC, UnitPeriodico, UnitDVD, UnitLivro, UnitLogin, Unit1,
  UnitMulta, UnitProfessor, UnitRetirada, UnitPesquisa, UnitUsuario;

{$R *.dfm}

procedure TFrmCadastroFuncionario.FlatButton1Click(Sender: TObject);
begin
  d := 1;
...
procedure TFrmCadastroFuncionario.FlatButton2Click(Sender: TObject);
begin
...
procedure TFrmCadastroFuncionario.FlatBtnLivroClick(Sender: TObject);
begin
  n := 'livro';
...
procedure TFrmCadastroFuncionario.FlatBtnDVDClick(Sender: TObject);
begin
...
procedure TFrmCadastroFuncionario.FlatBtnPeriodicosClick(Sender: TObject);
begin
  FlatGauge1.BarColor := StringToColor('$00F6F6F6');
  n := 'periodico';
  Timer4.Enabled := True;
...
procedure TFrmCadastroFuncionario.FlatBtnTCCClick(Sender: TObject);
begin
...
procedure TFrmCadastroFuncionario.FlatBtnAlunoClick(Sender: TObject);
begin
...
procedure TFrmCadastroFuncionario.FlatBtnProfessorClick(Sender: TObject);
begin
...
procedure TFrmCadastroFuncionario.FlatBtnMultaClick(Sender: TObject);
begin
...
procedure TFrmCadastroFuncionario.FlatBtnRetiradaClick(Sender: TObject);
begin
...
procedure TFrmCadastroFuncionario.FlatBtnLogoutClick(Sender: TObject);
begin
...
procedure TFrmCadastroFuncionario.FlatBtnSairClick(Sender: TObject);
begin
...
procedure TFrmCadastroFuncionario.Timer4Timer(Sender: TObject);
begin
...
procedure TFrmCadastroFuncionario.TimerTamanhoTimer(Sender: TObject);
begin
  if (d = 1)then
    begin
      if (FlatPanel3.Height >= 0) then
...
procedure TFrmCadastroFuncionario.TimerTamanho2Timer(Sender: TObject);
begin
  if (d = 1) then
    begin
      if (FlatPanel3.Height <= 525) then
...
procedure TFrmCadastroFuncionario.FlatBtnPesquisaClick(Sender: TObject);
begin
  n := 'pesquisa';
...
procedure TFrmCadastroFuncionario.FlatButton3Click(Sender: TObject);
begin
  d := 2;
...
procedure TFrmCadastroFuncionario.FormCloseQuery(Sender: TObject;
  var CanClose: Boolean);
begin
  Application.Terminate;
end;

procedure TFrmCadastroFuncionario.FlatBtnGravaClick(Sender: TObject);
begin
  ADOTable1.Post;
  ADOTable2.Post;
  ADOTable3.Post;
...
procedure TFrmCadastroFuncionario.FlatBtnAtualizaClick(Sender: TObject);
begin
  ADOTable1.Refresh;
  ADOTable2.Refresh;
  ADOTable3.Refresh;
...
procedure TFrmCadastroFuncionario.FlatBtnCancelaClick(Sender: TObject);
begin
  ADOTable1.Cancel;
  ADOTable2.Cancel;
  ADOTable3.Cancel;
...
procedure TFrmCadastroFuncionario.FlatBtnEditaClick(Sender: TObject);
begin
  ADOTable1.Edit;
  ADOTable2.Edit;
  ADOTable3.Edit;
...
procedure TFrmCadastroFuncionario.FlatBtnPrimeiroRegistroClick(
  Sender: TObject);
begin
  ADOTable1.First;
  ADOTable2.First;
...
procedure TFrmCadastroFuncionario.FlatBtnRegistroAnteriorClick(
  Sender: TObject);
begin
  ADOTable1.Prior;
  ADOTable2.Prior;
...
procedure TFrmCadastroFuncionario.FlatBtnUltimoRegistroClick(
  Sender: TObject);
begin
  ADOTable1.Last;
  ADOTable2.Last;
...
procedure TFrmCadastroFuncionario.FlatBtnProximoRegistroClick(
  Sender: TObject);
begin
  ADOTable1.Next;
  ADOTable2.Next;
...
procedure TFrmCadastroFuncionario.FlatBtnDeletaClick(Sender: TObject);
begin
  ADOTable1.Delete;
  ADOTable2.Delete;
  ADOTable3.Delete;
...
procedure TFrmCadastroFuncionario.FlatBtnNovoRegistroClick(
  Sender: TObject);
begin
  ADOTable1.Insert;
  ADOTable2.Insert;
...
procedure TFrmCadastroFuncionario.FlatBtnUsuarioClick(Sender: TObject);
begin
